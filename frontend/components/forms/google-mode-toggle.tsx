...
export function GoogleModeToggle({ enabled, onToggle }: GoogleModeToggleProps) {
  return (
    <div className="flex items-center justify-between p-4 bg-zinc-900 rounded-lg border border-zinc-800">
      ...
      <Switch.Root
        ...
        className="w-11 h-6 bg-zinc-700 rounded-full relative data-[state=checked]:bg-blue-600 transition-colors cursor-pointer"
      >
