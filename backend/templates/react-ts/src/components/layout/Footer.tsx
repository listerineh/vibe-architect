        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="/docs" className="text-sm text-gray-600 hover:text-indigo-600 transition-colors">
                  Documentation
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="/about" className="text-sm text-gray-600 hover:text-indigo-600 transition-colors">
                  About
                </a>
              </li>
              <li>
                <a href="/blog" className="text-sm text-gray-600 hover:text-indigo-600 transition-colors">
                  Blog
                </a>
              </li>
              <li>
                <a href="/contact" className="text-sm text-gray-600 hover:text-indigo-600 transition-colors">
                  Contact
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="/terms" className="text-sm text-gray-600 hover:text-indigo-600 transition-colors">
                  Terms
                </a>
              </li>
              <li>
                <a href="/cookies" className="text-sm text-gray-600 hover:text-indigo-600 transition-colors">
                  Cookies
                </a>
              </li>
            </ul>
