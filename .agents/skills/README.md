...
This directory contains AI agent skills that provide best practices, patterns, and guidelines for various technologies and frameworks.

> **Note**: The skills in this directory are for **this project's development**. The skills that are included in generated boilerplates are located in `backend/templates/.agents/skills/` and are automatically copied based on the selected tech stack.
